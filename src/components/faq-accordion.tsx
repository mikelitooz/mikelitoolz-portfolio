      ...
      {faqs.map((faq, index) => (
        <div key={index} className="border-b border-border/40">
          <button
            ...
            className="w-full py-6 text-left flex items-start justify-between gap-6 transition-colors hover:opacity-80"
          >
            <h3 className="text-lg font-medium text-foreground pr-4">{faq.question}</h3>
            <div className="cursor-pointer flex-shrink-0 w-6 h-6 rounded-[5px] bg-foreground flex items-center justify-center transition-all duration-300">
