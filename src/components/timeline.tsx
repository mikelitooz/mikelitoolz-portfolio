...
export function Timeline({ steps }: TimelineProps) {
  ...
  return (
    <div ref={timelineRef} className="relative max-w-4xl mx-auto">
      {/* Vertical Line */}
      <div ref={lineRef} className="absolute left-8 top-0 bottom-0 w-0.5 bg-accent/30 md:left-1/2 md:-translate-x-1/2" />
        ...
        {steps.map((step, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Center Node */}
              <div className="timeline-node absolute left-8 -translate-x-1/2 md:left-1/2 flex items-center justify-center">
