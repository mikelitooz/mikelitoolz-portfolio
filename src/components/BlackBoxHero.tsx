    ...
    <section ref={containerRef} className="relative bg-background" style={{ height: SCROLL_HEIGHT }}>
      ...
      <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        {!isLoaded && (
          <div className="absolute inset-0 flex items-center justify-center z-10 font-mono">
            <div className="flex flex-col items-center gap-4">
              <div className="w-12 h-1 bg-swiss-gray animate-pulse" />
              <p className="text-swiss-gray text-xs tracking-widest uppercase">[ Initializing System ]</p>
            </div>
          </div>
        )}
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          >
            <p className="text-xs md:text-sm text-accent tracking-[0.3em] uppercase mb-4 font-mono">[ Independent AI Engineer ]</p>
            <h1 className="text-5xl md:text-7xl lg:text-9xl font-bold text-foreground tracking-tighter uppercase font-sans">MICHEAL IFEANYI</h1>
            <p className="mt-4 text-lg md:text-xl text-swiss-gray max-w-2xl leading-relaxed font-mono">Architecting autonomous pipelines & robust billing engines that scale operations automatically.</p>
          </motion.div>
          ...
          >
            <h2 className="text-4xl md:text-6xl lg:text-8xl font-bold text-foreground tracking-tight uppercase">[ Automate ]</h2>
            <h2 className="text-4xl md:text-6xl lg:text-8xl font-bold text-swiss-gray tracking-tight uppercase">[ Operations ]</h2>
          </motion.div>
          ...
          >
            <h2 className="text-4xl md:text-6xl lg:text-8xl font-bold text-foreground tracking-tight uppercase">[ Intelligent ]</h2>
            <h2 className="text-4xl md:text-6xl lg:text-8xl font-bold text-swiss-gray tracking-tight uppercase">[ Pipelines ]</h2>
          </motion.div>
          ...
          >
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold text-foreground tracking-tight uppercase font-sans">Ready to Scale?</h2>
            <div className="mt-8 flex flex-col sm:flex-row items-center gap-4 font-mono text-sm">
              <button
                onClick={() => setIsCalendlyOpen(true)}
                className="px-8 py-4 bg-foreground text-background font-bold tracking-widest uppercase rounded-none hover:bg-accent hover:text-background transition-colors duration-300 pointer-events-auto"
              >
                Book Strategy Call
              </button>
              <a
                href="#projects"
                className="px-8 py-4 border border-swiss-gray/50 text-foreground font-bold tracking-widest uppercase rounded-none hover:border-accent hover:text-accent transition-colors duration-300 pointer-events-auto"
              >
                View Case Studies
              </a>
            </div>
